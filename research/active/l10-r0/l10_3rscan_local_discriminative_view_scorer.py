#!/usr/bin/env python3
"""Run the unchanged L10 scorer with local active-view Development authority."""
...
PROTOCOL_SCHEMA = "blindassist-l10-3rscan-local-discriminative-view-scorer-protocol-v1"
RESULT_SCHEMA = "blindassist-l10-3rscan-local-discriminative-view-scorer-result-v1"
        ...
        result.update(
            {
                ...
                "conclusion": protocol["materialized_conclusion"],
