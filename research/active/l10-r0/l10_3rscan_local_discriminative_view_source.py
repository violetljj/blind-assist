#!/usr/bin/env python3
"""Run the active-view source gate with local-Development authority."""
...
import l10_3rscan_discriminative_view_confirmation_source as base  # noqa: E402


PROTOCOL_SCHEMA = "blindassist-l10-3rscan-local-discriminative-view-source-protocol-v1"
RESULT_SCHEMA = "blindassist-l10-3rscan-local-discriminative-view-source-result-v1"
...
def run(protocol_path: Path, output_path: Path) -> None:
    ...
    pixel.require(
        pixel.sha256(HERE / base_row["path"]) == base_row["sha256"],
        ...
        result.update(
            {
                ...
                "authority": protocol["result_authority"],
                ...
                "conclusion": protocol["conclusions"][
                    "evaluable" if result["source_evaluable"] else "not_evaluable"
                ],
