#!/usr/bin/env python3
"""Run the third metadata-only observation candidate freeze."""
...
base.PROTOCOL_SCHEMA = (
    "blindassist-l10-3rscan-observation-adequacy-confirmation-candidate-freeze-protocol-v3"
)
base.COHORT_SCHEMA = "blindassist-l10-3rscan-observation-adequacy-confirmation-candidate-v3"
