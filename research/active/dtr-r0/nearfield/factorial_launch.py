"""Launch owned offscreen Unreal capture of NF-G9-B RGB-only trajectory capture."""
import argparse
import json
import os
...
def main():
    ...
    proc = subprocess.Popen([
        ...
        '-ExecCmds=py ' + Path(__file__).with_name('factorial_capture.py').as_posix(),
