"""Launch owned offscreen Unreal capture of frozen-map posed static temporal structure probe."""
import argparse
import json
import os
...
def main():
    ...
    proc = subprocess.Popen([
        ...
        '-ExecCmds=py ' + Path(__file__).with_name('capture_temporal_structure.py').as_posix(),
