"""Fresh rescue observations and full union-of-cuboids evaluator labels."""
...
def materialize(root):
    ...
    try:
        for i, (case, row, geo) in enumerate(zip(cases, manifests, geometry)):
            ...
            values, _ = simulate(sample_native(depth), 'local-rescue-fresh/'+case['sensor_noise_key'], boxes)
