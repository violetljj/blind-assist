"""One decisive-extrema availability fit with frozen MZ20 scores and cutoffs."""
import argparse
...
def main(root,output):
    ...
    control=work/'mz23-availability-20260910/run-v1'
    ...
    write(output/'start.json',dict(status='STARTED',inputs=inputs,steps=1200,seed=123,unique_train=len(np.unique(batches)),draws=int(batches.size),
        ...
        protocol_sha256=sha(Path(__file__).with_name('MZ24_DECISIVE_AVAILABILITY_PROTOCOL_20260910.md'))))
