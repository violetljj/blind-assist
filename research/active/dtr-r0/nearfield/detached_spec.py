"""G11 fresh TEST quartets; unchanged G10 narrow/diverse parameter ranges."""
import argparse
import json
...
def specification():
    preflight=False
    rng=random.Random(11080907);clips=[];cases=[];samples=[]
    count=32
    ...
    return dict(schema='nf-g11-detached-spec-v1',map_sha256=MAP_SHA,clips=clips,cases=cases,samples=samples,
