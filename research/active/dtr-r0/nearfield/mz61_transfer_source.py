"""Build an MZ61 transfer hardlink view, retaining raw native audits at their owner."""
import argparse
import hashlib
import json
import os
...
def build(source, output, receipt):
    ...
    native_record = dict(schema='mz61-native-retained-at-owner-v1',
    ...
    result = dict(status='PASS', schema='mz61-transfer-view-v1', source=str(source),
