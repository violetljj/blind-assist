"""Launch the one frozen 48-clip/576-frame local-rescue-fresh UE capture.
...
MANDATORY_CODE = {
    'local_rescue_capture.py', 'launch_local_rescue_fresh.py', 'local_rescue_source.py',
    'ue_capture_readiness.py',
    'core_transfer_spec.py', 'query_occupancy_data.py', 'query_occupancy_spec.py',
    'local_transfer_spec.py', 'local_stability_spec.py', 'data_coverage_spec.py', 'spatial_bce_spec.py',
    'run_local_rescue_fresh.py', 'local_rescue_data.py', 'local_rescue_inference.py',
    'ba_camera_corridor_spec.py',
    'LOCAL_RESCUE_FRESH_PROTOCOL_20260923.md',
}
MANDATORY_INPUTS = {
    ...
    'artifacts.local/evidence/ba-local-rescue-gate-20260923-run/gate.json',
    'research/active/dtr-r0/nearfield/LOCAL_RESCUE_GATE_PROTOCOL_20260923.md',
}
...
def validate_cases(data):
    from local_rescue_source import check_spec
    check_spec(data)
    cases = data['cases']
...
def main():
    ...
    capture_script = Path(__file__).with_name('local_rescue_capture.py').resolve()
    ...
    env = dict(os.environ, BA_LOCAL_RESCUE_FRESH_SPEC=str(spec), BA_LOCAL_RESCUE_FRESH_OUTPUT=str(out),
        BA_LOCAL_RESCUE_FRESH_SCRIPT=str(capture_script), BA_LOCAL_RESCUE_FRESH_PROTOCOL_SHA=source['protocol_sha256'],
        BA_LOCAL_RESCUE_FRESH_SPEC_SHA=source['spec_sha256'], BA_LOCAL_RESCUE_FRESH_SCRIPT_SHA=source['capture_script_sha256'])
