"""Launch owned offscreen Unreal capture of NF-G8 RGB-only trajectory capture."""
import argparse
import json
import os
...
def main():
    ...
    proc = subprocess.Popen([
        ...
        '-ExecCmds=py ' + Path(__file__).with_name('capture_whisker.py').as_posix(),
