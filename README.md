...
- 当前算法研究主线是 Assistive Geometry R2 因子化几何；其零模型、零真实数据的 F0 deterministic
  reducer synthetic kill gate 已 PASS，但 F1 factor learnability 仍未获得执行权限。DepthART-S 只保留为可替换的
