...
- Current project version: `v4.2.0`
...
当前已补存 v0.1.0、v0.2.0、v0.7.0、v0.8.0、v1.3.0、v1.4.0、v1.5.0、v2.0.0、v2.5.0、v2.6.0、v3.1.0、v3.2.0、v3.3.0、v3.4.0、v3.5.0、v3.6.0、v4.1.0 和 v4.2.0 的 debug APK。带 `rebuilt` 的文件表示从对应 Git 历史提交重新构建得到，适合用于演示版本演进；当前 v4.2.0 归档为 `releases/apk/BlindAssist-v4.2.0-debug-20260519-000200.apk`。
