...
状态：`CONSUMED / DENSE_IDENTITY_VALIDITY_SIGNAL_ESTABLISHED / NO_POLICY_ADMISSION / NO_SCIENTIFIC_VERDICT`。

结果：[`P1-A2 result`](P1_A2_FIXED_REFERENCE_DENSE_IDENTITY_RESULT_2026-08-21.md)。
