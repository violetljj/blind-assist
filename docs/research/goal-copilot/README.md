...
不建立 natural OCR/open-set calibration authority。当前唯一 successor 是把固定 V2 接到真实 RapidOCR polygon 输出的
门牌式 Development cohort；V4 active information gain、Android/P1 与默认 App 均不启动。
