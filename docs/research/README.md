...
| 分类 | 当前重点 | 入口 |
|---|---|---|
| 算法 | 当前主线是 BlindAssist Assistive Geometry；DepthART-S 是优先 encoder/initialization、depth baseline 与部署使能线；YOLO + 语义分割双环是论文次线 | [算法研究入口](ALGORITHM_RESEARCH_CURRENT.md) |
