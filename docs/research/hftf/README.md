...
它只允许另行激活已登记 exact-32 × 2 assets 的 64 个零正文 HEAD，并冻结 Content-Length、ETag 与
Last-Modified availability evidence；仍不得发 GET/Range、跟随 redirect、读取 depth/confidence body，
不得改写 32 身份或 300-frame windows，也不授权 first-16 selection、RGB、truth/model、
TRAIN/DEVELOPMENT、R2 或 outcome。
