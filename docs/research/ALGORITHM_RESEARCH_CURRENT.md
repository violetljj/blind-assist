...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO / CLOSE_NATURAL_SAGE_R / CONTROLLED_EXACT_ANCHOR_RETAINED / SAGE_LM_V0_CONTROLLED_36_POSITIVE / SAGE_LM_V1_REAL_RGB_ADAPTER_UPLIFT_NOT_PRESERVED / V1_A_ALL_ORACLE_24_OF_24_PASS / V1_B_R2_B0_24_OF_24_PASS / V1_B_R2_RGB_BOUNDARY_EXTRACTION_FAIL / ASSOCIATION_UNADJUDICATED / LIVE_ANDROID_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
confidence、`3/24` arrival。当前可裁决失败层是 RGB boundary candidate extraction；automatic association 因上游候选
recall 不足仍未被单独裁决。任何
...
| Goal Copilot / SAGE-LM last mile | exact identity 后，真实 RGB observation 能否忠实恢复 active aperture geometry | `R2 PAIR GATE=24/24 / B0=24/24 PASS / B1 GEOMETRY=2/24 CONFIDENCE=0/24 ARRIVAL=0/24 / RGB BOUNDARY EXTRACTION FAIL / B2 ASSOCIATION UNADJUDICATED` | [V1-B-R2 result](goal-copilot/SAGE_LM_V1_B_R2_CORRECT_POSE_BOUNDARY_RESULT_2026-08-24.md) | 无自动 successor；下一版本须先改变 RGB boundary representation 并建立 candidate recall，再独立裁决 association | 在 R2 outcome 上挑 pair/缩分母/降 9px 或 confidence 门；把 B2 当独立 association negative；改 policy/baseline/anchor；VO/Android/P1/App | 否 |
