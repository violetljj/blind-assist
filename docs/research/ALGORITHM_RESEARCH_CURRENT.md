...
|---|---|---|---|---|---|---|
| GRAIL-R / relational interaction pose | owner-centric canonical relation 能否视觉获得并恢复 R1C-O ceiling | `R1C-O: 75/78,58/78 / R1C-V AXIS-ONLY SLOT=45/78 / SIGN-ONLY=40/78 / FINAL=39/78, REFERENT=38/78, COMPLETE=27/78 / AXIS FRONT DOOR FAILED; SIGN ALSO FAILED / CURRENT ESTIMATOR CLOSED / STOP_BEFORE_M2` | [GRAIL-R1C-V result](goal-copilot/GRAIL_R1C_V_VISUAL_OWNER_ORIENTATION_RESULT_2026-08-25.md) | 无自动 successor；改变独立 orientation 信息源须另行协议与授权 | consumed artifact 调 PCA/padding/sign/UNKNOWN/bin/matcher/fusion；diagnostic 晋级；learned head；formal test；M2；Android/App 晋升 | 否 |
