...
| Goal Copilot / SAGE-R semantic graph + referent belief V2 | relational semantic anchors、NONE/UNKNOWN 与 correlated evidence suppression 是否修复 substring/FSM 的 hard semantic failure | `SYNTHETIC_OCR_STAGE_DEVELOPMENT / CORRECT 3/23 -> 12/23 / WRONG_LOCK 6 -> 0 / NONE 0 -> 3 / UNKNOWN 0/3 -> 3/3` | [V2 result](goal-copilot/SEMANTIC_ANCHOR_GRAPH_AND_BELIEF_V2_RESULT_2026-08-24.md) | 固定 V2 接真实 RapidOCR polygon，自动建门牌/directory/absence Development cohort | 把 synthetic token 当自然 OCR；结果后扫 belief threshold；启动 V4 active information gain；Android/P1/default-App 晋升 | 否 |
