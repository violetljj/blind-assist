...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / P0_POLICY_DISCOVERY_CLOSED / P1_A_CLOSED / P1_W0_DESIGN_COMPLETE / P1_W1_MINIMAL_BASELINE_PROTOCOL_FROZEN / IMPLEMENTATION_NOT_SELECTED / NO_EXECUTION / NO_POLICY_ADMISSION / NO_SKY / DEFAULT_APP_UNCHANGED`
...
[`P1-W1 protocol`](goal-copilot/P1_W1_MINIMAL_WORLD_REFERENT_BASELINE_PROTOCOL_V1.md) 现已冻结 C0 honest
...
reacquisition 决定。实现、数据、pose source 和 execution 仍未授权。
...
|---|---|---|---|---|---|---|
| Goal Copilot / P1 Target Persistence | scene-fixed referent 的最小空间记忆 | `P1_W1_MINIMAL_BASELINE_PROTOCOL_FROZEN / NO_EXECUTION / DEFAULT_APP_UNCHANGED` | [current](goal-copilot/README.md) / [W1 protocol](goal-copilot/P1_W1_MINIMAL_WORLD_REFERENT_BASELINE_PROTOCOL_V1.md) | `P1_W1_STAGE_A_OUTCOME_BLIND_IMPLEMENTATION_AND_DATA_SELECTION`；需另行授权 | A5+ tracker zoo；直接执行 W1；提前选 T1；SLAM/object map；单通道 reacquisition；App | 否 |
