...
| TARO / Task-directed Active Risk Observability | 同预算观测使 body/path query 更早可识别 | `R31_V6_LEAK_INVALIDATED / R36_FRESH_PARENT_FAIL / R37_OPENLORIS_DEVELOPMENT_FAIL / R37_CLOSED / R38_R32_ARKIT_FRESH_PARENT_SOURCE_MATERIALIZED / OUTCOME_SEALED / USER_PAUSED` | [TARO current](taro/README.md) | 按用户恢复指令执行 R38 reference-input-only preflight，冻结 reference/candidate role-disjoint identity 后，对 R32 做一次 ARKitScenes Validation fresh-parent confirmation | 回调 R31/R35/R36/R37；用 R38 candidate depth、target gain 或 fresh-parent 分数调 R32；接默认 App/risk/guidance；夸大为 fresh-source、broad breakthrough、安全或产品成功 | 否 |
