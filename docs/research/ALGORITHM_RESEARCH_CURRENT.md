...
状态：`current / PRODUCT_RESEARCH_MAINLINE=DESTINATION_GOAL_GROUNDING / GOAL_GROUNDING_P0 / P0_CONTRACT_V1_REFERENCE_SET_ADDENDUM / MAPILLARY_TOKEN_READY / GROUNDING_DINO_PROPOSAL_PATH_RUN / SILVER_B_DEVELOPMENT_COHORT_4 / NO_BASELINE / R5_PERMANENTLY_CLOSED / NO_R6_R7 / NO_SKY / DEFAULT_APP_UNCHANGED`
...
|---|---|---|---|---|---|---|
| Goal Copilot / Destination Grounding | 目标建筑入口归属 | `PRODUCT_AND_RESEARCH_MAINLINE / DESTINATION_GOAL_GROUNDING_P0 / SILVER_B_DEVELOPMENT_COHORT_4 / NO_BASELINE / DEFAULT_APP_UNCHANGED` | [current](goal-copilot/README.md) / [Silver-B addendum](goal-copilot/P0_SILVER_B_DEVELOPMENT_ADDENDUM_V1.md) / [P0-S1](goal-copilot/P0_S1_CROSSVIEW_ENTRANCE_IDENTITY_RESULT_2026-08-21.md) | `BA_DESTINATION_GOAL_GROUNDING_R0`：扩大普通 anchor-facing coverage，物化几十至约 100 个 B 级 Development episodes，再做 bounded provider/Brain mechanics；天然 A 另存 subset | 把 B 当 exact entrance truth；报告 detector recall/precision 或 exact Brain/E2E accuracy；回写 S1；比较/更换 detector；Sky、Android | 否 |
