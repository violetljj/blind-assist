...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO / CLOSE_NATURAL_SAGE_R / CONTROLLED_EXACT_ANCHOR_RETAINED / SAGE_LM_V0_CONTROLLED_36_POSITIVE / V1_A_ALL_ORACLE_24_OF_24_PASS / V1_B_R2_B0_24_OF_24_PASS / R3_DENSE_FIELD_PARTIAL_RESCUE_BELOW_GATE / R4_JOINT_SUPPORT_ACCUMULATION_REJECTED / B2_NOT_RUN / LIVE_ANDROID_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
被拒绝。B2 不运行、association 仍未裁决。任何
...
| Goal Copilot / SAGE-LM last mile | exact identity 后，真实 RGB observation 能否忠实恢复 active aperture geometry | `R2 B0=24/24 / R3 TRUE-PAIR=15 GEOMETRY=13 CONFIDENT=0 MISSING=9 / DENSE FIELD PARTIAL RESCUE BELOW GATE / R4 TRUE-PAIR=9 GEOMETRY=8 MISSING=15 / JOINT SUPPORT OBJECTIVE REJECTED / B2 NOT RUN` | [R3/R4 result](goal-copilot/SAGE_LM_V1_B_R3_R4_DENSE_BOUNDARY_RESULT_2026-08-25.md) | 无自动 successor；新版本须改变 proposal objective，引入 task-specific boundary coverage 或 diversity-aware geometry proposal | 调 R3/R4 threshold/grid/top-k/support/9px/confidence；扫 detector zoo；运行/调 B2；改 policy/baseline/anchor；VO/Android/P1/App | 否 |
