...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / P0_POLICY_DISCOVERY_CLOSED / P1_TARGET_PERSISTENCE / P1_A2_DENSE_IDENTITY_SIGNAL_RETAINED / P1_A3_TEMPORAL_POLICY_INSUFFICIENT / NO_POLICY_ADMISSION / P1_A4_ONLINE_CORRESPONDENCE_PROTOCOL_FROZEN / PYTORCH_ONLINE_BOOTSTAPIR_SELECTED / PERFORMANCE_NOT_RUN / NO_SKY / DEFAULT_APP_UNCHANGED`
...
P1-A4 strictly causal correspondence/output/evaluator contract 已冻结；outcome-blind preflight 已固定 official PyTorch
Online BootsTAPIR，未测试 fallback。当前尚未执行 capability probe 或读取 private truth。
...
|---|---|---|---|---|---|---|
| Goal Copilot / P1 Target Persistence | 已建立 physical referent 的身份连续性、丢失与保守重捕获 | `PRODUCT_AND_RESEARCH_MAINLINE / P1_A2_DENSE_IDENTITY_SIGNAL_RETAINED / P1_A3_TEMPORAL_POLICY_INSUFFICIENT / NO_POLICY_ADMISSION / P1_A4_ONLINE_CORRESPONDENCE_PROTOCOL_FROZEN / PYTORCH_ONLINE_BOOTSTAPIR_SELECTED / PERFORMANCE_NOT_RUN / DEFAULT_APP_UNCHANGED` | [current](goal-copilot/README.md) / [P1-A4 protocol](goal-copilot/P1_A4_ONLINE_STRONG_TEMPORAL_CORRESPONDENCE_PROTOCOL_V1.md) / [selection](goal-copilot/P1_A4_ONLINE_TAPIR_SELECTION_2026-08-21.md) | 同一 frozen PyTorch Online BootsTAPIR 的一个 capability probe | 跑模型 zoo；offline/future-frame primary；A2/A3 gate；global search；ReID/Sky/fresh cohort/Android；改 evaluator/truth firewall | 否 |
