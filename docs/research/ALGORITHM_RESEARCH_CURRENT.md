...
| Goal Copilot / SAGE-R typed semantic-referent graph V3-A | learned typed relation scorer 能否在冻结 V2 belief 下增加 physical-referent evidence，而不是只增加 abstention | `SYNTHETIC_GRAPH_TRAIN / V2_1_TUNED_ON_DEVELOPMENT / V2 CORRECT=9 TARGET=6/7 NONE=3/7 WRONG=0 / NO_RELATION CORRECT=7 TARGET=0/7 / FULL CORRECT=14 TARGET=7/7 NONE=7/7 WRONG=0 UNKNOWN=2/2 / NATURAL_PHOTO_NOT_RUN` | [V3-A result](goal-copilot/TYPED_SEMANTIC_REFERENT_GRAPH_V3_A_RESULT_2026-08-25.md) | 冻结 full scorer，建立未参与开发的自然照片 source-disjoint door/directory/gate/office/exit/area Development cohort | 把 tuned generated pixels 当自然泛化；修改 V2 belief/threshold；启动 V3-B/V4；Android/P1/default-App 晋升 | 否 |
