...
P1-A4 strictly causal correspondence/output/evaluator contract 已冻结；当前只授权 outcome-blind official interface、
checkpoint、license 与本机 runtime preflight，尚未选模或执行 capability probe。
...
|---|---|---|---|---|---|---|
| Goal Copilot / P1 Target Persistence | 已建立 physical referent 的身份连续性、丢失与保守重捕获 | `PRODUCT_AND_RESEARCH_MAINLINE / P1_A2_DENSE_IDENTITY_SIGNAL_RETAINED / P1_A3_TEMPORAL_POLICY_INSUFFICIENT / NO_POLICY_ADMISSION / P1_A4_ONLINE_CORRESPONDENCE_PROTOCOL_FROZEN / DEFAULT_APP_UNCHANGED` | [current](goal-copilot/README.md) / [P1-A4 protocol](goal-copilot/P1_A4_ONLINE_STRONG_TEMPORAL_CORRESPONDENCE_PROTOCOL_V1.md) / [P1-A3 result](goal-copilot/P1_A3_TEMPORAL_LOSS_DECLARATION_RESULT_2026-08-21.md) | outcome-blind official implementation selection + one local mechanics smoke；private performance execution=false | 跑模型 zoo；offline/future-frame primary；A2/A3 gate；global search；ReID/Sky/fresh cohort/Android；改 evaluator/truth firewall | 否 |
