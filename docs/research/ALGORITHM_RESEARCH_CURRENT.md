...
| Goal Copilot / SAGE-LM last mile | exact identity 后，真实 RGB observation 能否忠实恢复 active aperture geometry | `R3 TRUE-PAIR=15 GEOMETRY=13 / R5=12/12 / R5S=11/11 / V1-C0=1/1 / V1-C1=3/3, FOUR-BOUNDARY=4/24 / R6 NOT RUN / B2 NOT RUN` | [V1-C result](goal-copilot/SAGE_LM_V1_C_TASK_SPECIFIC_APERTURE_BOUNDARY_FIELD_RESULT_2026-08-25.md) | 无自动 successor；新 supervision 必须先提供覆盖弱 aperture boundary 的独立标签分母 | 在已打开 cohort 扫 CNN/head/epoch/loss/top-k；重采样现有 strong-line proxy；调 9px/confidence；运行 R6/B2；Android/P1/App | 否 |
