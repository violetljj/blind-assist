...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO / CLOSE_NATURAL_SAGE_R / CONTROLLED_EXACT_ANCHOR_RETAINED / SAGE_LM_V0_CONTROLLED_36_POSITIVE / V1_A_ALL_ORACLE_24_OF_24_PASS / V1_B_R2_B0_24_OF_24_PASS / R3_RETAINED_FROZEN_REFERENCE / R4_JOINT_SUPPORT_ACCUMULATION_REJECTED / R5_DIVERSITY_AWARE_PAIR_COVERAGE_BELOW_R3 / R5S_SEQUENCE_DISJOINT_BOUNDARY_HEAD_REJECTED / V1_C0_C1_TASK_BOUNDARY_FIELD_BELOW_R3 / V1_F_PORTAL_INTERIOR_TRUE_PAIR_0_OF_24_GEOMETRY_10_OF_24_RETENTION_0_OF_18_RESCUE_0_OF_6 / FOUR_BOUNDARY_MAINLINE_REPRESENTATION_CLOSED / R6_NOT_RUN / B2_NOT_RUN / V2_MARKER_POSE_ANDROID_IMPLEMENTED_LIVE_DEVICE_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
| Goal Copilot / semantic anchor + marker pose live seam | 独立 exact QR identity 与已知尺寸平面姿态能否接成可展示的 target-front 闭环 | `CONTROLLED SEMANTIC 16/16, WRONG_LOCK=0 / ANDROID QR+PLANAR-PNP IMPLEMENTED / JVM 8/8 / APK BUILT / LIVE DEVICE NOT RUN` | [V2 marker-pose implementation](goal-copilot/SAGE_LM_V2_MARKER_POSE_LIVE_SEAM_IMPLEMENTATION_2026-08-25.md) | 唯一 ready physical device 上跑 matched center baseline/PnP controlled matrix，报告真实 arrival/lateral/yaw/premature/reacquire | 把 JVM/assemble 写成 live camera；重复 ID 冒充 unique instance；默认 App/P1/自然入口/导航/安全晋升 | 否 |
