...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PUBLIC_REAL_8X89_SEALED / PUBLIC_REFERENT_VISIBLE_16_OF_20_SAME_INSTANCE / DINOV2_LOCAL_13_OF_17 / TWO_REFERENCE_ZERO_RESCUE_THREE_COLLATERAL / TLESS_DINO_BASELINE_27_OF_30 / PDM_RESCUE_1_COLLATERAL_4_CONTROL_4_OF_6 / PDM_UNARY_REJECTED / IDENTITY_FAILURE_AUDIT_NEARID_JUSTIFIED / NEARID_NOT_RUN / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / ACTIVE_APPEARANCE_ANCHOR_NO_UPLIFT / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO_16_OF_16_ZERO_WRONG_LOCK_4_OF_4_REACQUISITION / SAGE_R_V3_A_TUNED_FULL_14_OF_16 / NATURAL_SOURCE_DISJOINT_9_SOURCES_12_QUERIES_36_OBSERVATIONS / V2_CORRECT_4_FULL_CORRECT_3_FULL_WRONG_LOCK_9_NO_RELATION_TARGET_0_OF_27 / DO_NOT_ENTER_V3_B / V4_NOT_RUN / LIVE_ANDROID_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
| Goal Copilot / SAGE-R typed semantic-referent graph V3-A | learned typed relation scorer 能否在冻结 V2 belief 下增加 physical-referent evidence，而不是只增加 abstention | `NATURAL_SOURCE_DISJOINT_DEVELOPMENT / 9 SOURCES / 12 QUERIES / 36 OBS / V2 CORRECT=4 TARGET=2/27 NONE=2/6 WRONG=1 / NO_RELATION TARGET=0/27 / FULL CORRECT=3 TARGET=3/27 NONE=0/6 WRONG=9 DIRECTORY_FALSE=2 / PERMUTATION=36/36 / DO_NOT_ENTER_V3_B` | [natural result](goal-copilot/SAGE_R_V3_A_NATURAL_PHOTO_SOURCE_DISJOINT_RESULT_2026-08-24.md) | 另立 successor 前先修 graph input representation：OCR grouping、sign-to-destination association、directional geometry normalization、missing-token open-set behavior；须用全新预冻结 cohort | 在本 sealed cohort 换图/改 truth-candidate/调阈值/重跑；加 GNN 层；训练 V3-B belief；启动 V4；Android/P1/default-App 晋升 | 否 |
