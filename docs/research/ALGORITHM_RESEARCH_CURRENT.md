...
状态：`current / PRODUCT_RESEARCH_MAINLINE=DESTINATION_GOAL_GROUNDING / GOAL_GROUNDING_P0 / P0_CONTRACT_V1_FROZEN / MAPILLARY_TOKEN_READY / P0_S0_VISUAL_CANDIDATE_GENERATOR_NOT_ADMITTED / NO_COHORT_BASELINE / R5_PERMANENTLY_CLOSED / NO_R6_R7 / NO_SKY / DEFAULT_APP_UNCHANGED`
...
|---|---|---|---|---|---|---|
| Goal Copilot / Destination Grounding | 目标建筑入口归属 | `PRODUCT_AND_RESEARCH_MAINLINE / DESTINATION_GOAL_GROUNDING_P0 / P0_CONTRACT_V1_FROZEN / MAPILLARY_TOKEN_READY / P0_S0_VISUAL_CANDIDATE_GENERATOR_NOT_ADMITTED / NO_COHORT / NO_BASELINE / DEFAULT_APP_UNCHANGED` | [current](goal-copilot/README.md) / [S0 result](goal-copilot/P0_S0_SILVER_MATERIALIZATION_CANARY_RESULT_2026-08-21.md) / [V0 result](goal-copilot/P0_S0_VISUAL_CANDIDATE_GENERATOR_ADMISSION_RESULT_2026-08-21.md) | `BA_DESTINATION_GOAL_GROUNDING_R0`：补齐一个 provenance/replay 完整的 proposal-only generator admission 后新建 S0-R1 | 将 map/cluster/fixture 或 detector confidence 升为 silver；使用未获准 checkpoint；baseline、Sky、Android | 否 |
