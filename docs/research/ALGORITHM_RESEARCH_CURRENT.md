...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO / CLOSE_NATURAL_SAGE_R / CONTROLLED_EXACT_ANCHOR_RETAINED / SAGE_LM_V0_CONTROLLED_36_POSITIVE / V1_A_ALL_ORACLE_24_OF_24_PASS / V1_B_R2_B0_24_OF_24_PASS / R3_DENSE_FIELD_PARTIAL_RESCUE_BELOW_GATE / R4_JOINT_SUPPORT_ACCUMULATION_REJECTED / R5_DIVERSITY_AWARE_PAIR_COVERAGE_BELOW_R3 / R5S_SEQUENCE_DISJOINT_BOUNDARY_HEAD_REJECTED / R6_NOT_RUN / B2_NOT_RUN / LIVE_ANDROID_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
| Goal Copilot / SAGE-LM last mile | exact identity 后，真实 RGB observation 能否忠实恢复 active aperture geometry | `R3 TRUE-PAIR=15 GEOMETRY=13 / R4=9/8 / R5 PAIR-DIVERSITY=12/12 / R5S SEQUENCE-DISJOINT HEAD=11/11, TOP8-FOUR-BOUNDARY=5/24 / R6 NOT RUN / B2 NOT RUN` | [R5 result](goal-copilot/SAGE_LM_V1_B_R5_ANCHOR_PAIR_COVERAGE_RESULT_2026-08-25.md) | 无自动 successor；若继续 supervision，须建立新的预先分离训练 denominator 或更保真 representation | 在已打开 cohort 扫 head/feature/loss/top-k；调 support/9px/confidence；运行/调 B2/R6；扫 detector；Android/P1/App | 否 |
