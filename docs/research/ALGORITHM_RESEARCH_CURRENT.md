...
状态：`current / PRODUCT_RESEARCH_MAINLINE=GOAL_DRIVEN_VISUAL_COPILOT / PASSIVE_SINGLE_REFERENCE_RGB_EXACT_INSTANCE_MAINLINE_STOP / SEMANTIC_ANCHOR_V1_CONTROLLED_DEMO / CLOSE_NATURAL_SAGE_R / CONTROLLED_EXACT_ANCHOR_RETAINED / SAGE_LM_V0_CONTROLLED_36_POSITIVE / V1_A_ALL_ORACLE_24_OF_24_PASS / V1_B_R2_B0_24_OF_24_PASS / R3_DENSE_FIELD_PARTIAL_RESCUE_BELOW_GATE / R4_JOINT_SUPPORT_ACCUMULATION_REJECTED / R5_DIVERSITY_AWARE_PAIR_COVERAGE_BELOW_R3 / R5S_SEQUENCE_DISJOINT_BOUNDARY_HEAD_REJECTED / V1_C0_C1_TASK_BOUNDARY_FIELD_BELOW_R3 / R6_NOT_RUN / B2_NOT_RUN / LIVE_ANDROID_NOT_RUN / NO_P1 / DEFAULT_APP_UNCHANGED`
...
当前 endpoint 条件；其中 endpoint relative rotation median 约 `20.1 deg`、`6/24 >30 deg`。唯一 successor 为从
ARKitScenes mesh/Faro depth 建立独立弱 aperture boundary teacher 的 V1-E privileged geometry supervision。V1-E0 已用
...
固定 pair 同时刻覆盖不足未形成完整 24-case ceiling。
...
| Goal Copilot / SAGE-LM last mile | exact identity 后，真实 RGB observation 能否忠实恢复 active aperture geometry | `R3 TRUE-PAIR=15 GEOMETRY=13 / V1-C1=3/3 / V1-D=4/4, RESCUE=0/9 / V1-E0 MESH TEACHER: FOUR-BOUNDARY=10/24, PAIR=9/24, GEOMETRY=9/24, RESCUE=3/9, RETAIN=6/15 / C,D,E0 CLOSED / R6 NOT RUN / B2 NOT RUN` | [V1-E0 result](goal-copilot/SAGE_LM_V1_E0_PRIVILEGED_GEOMETRY_TEACHER_CEILING_RESULT_2026-08-25.md) | 无；只有新的同时间 Faro/full privileged geometry source 或独立 aperture mapping protocol 才可重新授权 teacher | 当前 24 条扫 mesh jump/coherence/top-k/pair/gate；训练 heatmap/signed-field student 或新 backbone；R3 fusion；运行 R6/B2；Android/P1/App | 否 |
