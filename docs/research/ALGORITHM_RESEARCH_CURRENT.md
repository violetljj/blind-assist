...
| Goal Copilot / SAGE-R semantic graph + referent belief V2.1 | relational semantic anchors、NONE/UNKNOWN 与 correlated evidence suppression 是否从 synthetic token 迁移到真实 RapidOCR polygon/confidence | `GENERATED_PIXEL_SCENE_RAPIDOCR_DEVELOPMENT / CORRECT 1/16 -> 9/16 / WRONG_LOCK 4 -> 0 / NONE 0 -> 3 / UNKNOWN 0/2 -> 2/2 / NATURAL_PHOTO_NOT_EVALUATED` | [V2.1 result](goal-copilot/SEMANTIC_ANCHOR_GRAPH_AND_BELIEF_V2_1_REAL_OCR_TRANSFER_RESULT_2026-08-24.md) | V3 小型 learned relational scorer：domain-randomized graph training，未参与训练的自然照片门牌/directory Development test | 把 generated pixels 当自然照片；结果后扫 V2 belief threshold；启动 V4 active information gain；Android/P1/default-App 晋升 | 否 |
