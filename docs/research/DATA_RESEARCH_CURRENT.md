...
| BA-ADT Goal Episode mining | `REVERSIBLE_EXPLORATION / ADT_0_FULL_SEQUENCE_TARGET_SELECTED / SEQ136_CARROT` | [Goal Copilot current](goal-copilot/README.md)；[sample result](goal-copilot/BA_ADT_REAL_EVIDENCE_ADT0_SAMPLE_RESULT.md)；[selection result](goal-copilot/BA_ADT_REAL_EVIDENCE_ADT0_SELECTION_ADT1_CANARY_RESULT.md)；实现见 [`ba_adt_real_evidence`](../../scripts/research/ba_adt_real_evidence/README.md) | manifest transport 恢复后只下载已选 `seq136` RGB；GT 与 RGB estimator 严格分离 |
