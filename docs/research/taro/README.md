...
`TARO_O1R_R11_FRESH_48_PARENT_BOUNDED_SOURCE_DOWNLOAD_IMPLEMENTATION_LOCK`，必须绑定真实总量
`2,960,390,828 bytes` 后才可另锁 GET；当前 source body、DepthART 和 FARO 仍为 0，也没有 TARO
