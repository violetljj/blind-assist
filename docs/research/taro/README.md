...
当前唯一 successor 是
`RUN_READ_ONLY_R11_PHASE_A_ROUND12_REPRESENTATION_REPAIR_ATTEMPT_02_AUDIT`：先把新绑定 Attempt 02 推送到 master，再对同一
