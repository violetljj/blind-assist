...
`testzip/open/read`，声明 CRC 不冒充 member payload CRC 验证。唯一 successor 是另提交并消费一次
`TARO_O1R_R11_FRESH_48_PARENT_SOURCE_INVENTORY_ONE_SHOT_EXECUTION_LOCK`；在该锁消费前正式 inventory、
