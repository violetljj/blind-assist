...
hash/CRC/manifest 重验，正式终态为 `TARO_O1R_R11_FRESH_POOL_SOURCE_DOWNLOAD_INTEGRITY_PASS`。唯一
successor 是 `TARO_O1R_R11_FRESH_48_PARENT_SOURCE_INVENTORY_IMPLEMENTATION_LOCK`，只实现本地 ZIP
inventory/CRC/exact frame-plan；DepthART 和 FARO 仍为 0，也没有 TARO
