...
状态：`current / PAUSED / NO_ACTIVE_EXECUTION / USER_PAUSED_2026-07-30 / STAGE_B_COMPLETE_B_ORACLE_NOT_EVALUABLE / R3_LEAKAGE_LOCALIZATION_FORMAL_COMPLETE_INDEPENDENT_VALIDATION_INVALID_ONE_SHOT_CONSUMED_NO_RERUN / C_D_CLOSED / SUCCESSOR_FORMAL_NOT_CONSUMED / DEFAULT_APP_UNCHANGED`
