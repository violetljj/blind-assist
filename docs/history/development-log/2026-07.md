...
- 修改文件：
  ...
  - 测试架构：新增 `apps/benchmarks/device-benchmark/`，迁移 Detector A/B benchmark，删除旧 `Yolo26nDeviceBenchmarkTest`，收窄 `app/src/androidTest`。
...
- 修改范围：
  ...
  - `apps/benchmarks/device-benchmark/.../DetectorAbDeviceBenchmarkTest.kt`
