...
| [EgoTraj](https://github.com/yehiahmad/EgoTraj) | 75 位参与者、城市第一视角 RGB、头位姿、gaze；视频已隐私模糊。场景说明由 Qwen2.5-VL 生成，仓库许可证限制 academic/non-commercial research。 | `representation_candidate_only_pending_license_privacy_review`：若后续获得明确授权，只能作为无标签/自监督表征候选。 | VLM scene annotation 不是人工事件真值；不得以轨迹、gaze、VLM 或运动几何构造风险、生命周期或 alert 标签；不得进入商业/产品训练路径。 |
