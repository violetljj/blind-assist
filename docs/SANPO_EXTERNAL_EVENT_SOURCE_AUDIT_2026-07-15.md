...
> 2026-07-22 原则更新：本文保留 2026-07-15 的来源审计事实；其中“许可或隐私收据缺失即阻止下载”的旧规则已被替代。普通公开渠道可下载的数据现在可凭来源 URL、抓取时间和哈希立即用于隔离内部研究；外部上传、共享/再分发、商业发布和生产晋级仍单独评估。
...
4. YouTube 或其他公开视频只要可通过普通公开渠道取得，即可下载、自动标注并用于隔离内部训练；来源 URL、抓取时间和哈希必记，许可/隐私未知项作为 limitation。GPT/Codex 事件共识仍决定事件标签 authority，但不阻止无标签或银标研究。
