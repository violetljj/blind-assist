...
- [RCLE 研究主线](research/rcle/README.md)：`current`；R1.0 长期能力地图、R1.1 Phase A R0/R1 终态、`STOP_CURRENT_IMPLEMENTATION`、Observable Support Recovery R0 design-only 冻结和旧 USTRF/Looming 证据关系的唯一仓库入口。
