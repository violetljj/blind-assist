...
| GRAIL set-valued interaction-pose teacher 与 GRAIL-R relational oracle | [`GRAIL-R1C-P paired orientation result`](research/goal-copilot/GRAIL_R1C_P_SYMMETRY_AWARE_PAIRED_ORIENTATION_RESULT_2026-08-25.md) | `scripts/research/grail/`；M0/R0/R1 ownership-coordinate chain、R1C-O owner-local ceiling，以及已关闭的 R1C-V deterministic probe 与 R1C-P fixed OA-V2 paired probe，均不修改默认 `:app` |
