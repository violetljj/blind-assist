...
| AG-QSF 并行路线、共享资源 manifest 与输出隔离门 | [`assistive_geometry_qsf/README.md`](../scripts/research/assistive_geometry_qsf/README.md) | `validate_qsf_preparation.py`；后续 H1 target/survival 与 H2 profile-query 实现只进入该 Module |
