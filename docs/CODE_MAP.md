...
| Goal Copilot P0/P1 bridge、current-frame selective guidance contract 与历史研究 runner | [`goal_copilot_bridge/README.md`](../scripts/research/goal_copilot_bridge/README.md) | `scripts/research/goal_copilot_bridge/`；V0 contract 在 `selective_guidance_v0/` |
