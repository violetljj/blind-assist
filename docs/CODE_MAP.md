...
| TARO O0M execution-family non-execution 协议锁 | [`taro_o0m/README.md`](../scripts/research/taro_o0m/README.md) | `validate_taro_o0m_protocol.py`、`test_validate_taro_o0m_protocol.py`；runtime 与 runner 尚未授权 |
