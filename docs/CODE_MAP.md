...
| GRAIL set-valued interaction-pose teacher 与 GRAIL-R relational oracle | [`GRAIL-R1 signature ablation`](research/goal-copilot/GRAIL_R1_SIGNATURE_OBSERVABILITY_ABLATION_RESULT_2026-08-25.md) | `scripts/research/grail/`；M0 teacher、frozen M1、privileged R0 与 signature observability diagnostic，均不修改默认 `:app` |
