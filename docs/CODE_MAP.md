...
| Assistive Geometry 训练、Development/failure-anatomy、R2 reducer/F1-P、deterministic FactorTensorAdapter、跨传感器 factor Confirmation executor、teacher/mobile/temporal mechanics | [`assistive_geometry/README.md`](../scripts/research/assistive_geometry/README.md) | `train_b1_a0_formal.py`、`train_b1_additive_arm.py`、`materialize_b1_development_targets.py`、`observe_b1_a0_development.py`、`evaluate_b1_a0_development.py`、`analyze_b1_a0_failure_anatomy.py`、`geometry_r2_reducer.py`、`run_geometry_r2_f0_canary.py`、`validate_geometry_r2_f1_protocol.py`、`audit_geometry_r2_f1_adapter_gap.py`、`factor_tensor_adapter.py`、`run_factor_tensor_adapter_canary.py`、`ag_r2_cross_sensor_confirmation/`、`run_ag_r2_cross_sensor_factor_accuracy_confirmation.py`、`evaluate_teacher_complementarity.py`、`export_assistive_geometry_onnx.py`、`temporal_geometry_ablation.py`、`run_hypothesis_canary_lite.py` |
