...
| Assistive Geometry 训练、Development/failure-anatomy、R2 deterministic reducer/F1-P 静态协议、teacher/mobile/temporal mechanics 与数学 canary | [`assistive_geometry/README.md`](../scripts/research/assistive_geometry/README.md) | `train_b1_a0_formal.py`、`train_b1_additive_arm.py`、`materialize_b1_development_targets.py`、`observe_b1_a0_development.py`、`evaluate_b1_a0_development.py`、`analyze_b1_a0_failure_anatomy.py`、`geometry_r2_reducer.py`、`run_geometry_r2_f0_canary.py`、`validate_geometry_r2_f1_protocol.py`、`evaluate_teacher_complementarity.py`、`export_assistive_geometry_onnx.py`、`temporal_geometry_ablation.py`、`run_hypothesis_canary_lite.py` |
...
| AG-DUE gap-driven source prescreen、claim-bound evidence 与数据角色防火墙 | [`assistive_geometry_data_upgrade/README.md`](../scripts/research/assistive_geometry_data_upgrade/README.md) | `validate_due_r0.py`、`test_validate_due_r0.py`；metadata-only `PRESCREEN_ADMIT` 不建立 source data support、DCA PASS 或执行权限 |
