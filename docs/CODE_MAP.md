...
| Goal Copilot public-real episode mining、current-frame selective guidance contract 与历史 runner | [`goal_copilot_bridge/README.md`](../scripts/research/goal_copilot_bridge/README.md) | `scripts/research/goal_copilot_bridge/`；当前实现为 `real_episode_pilot_v0/` 与 `selective_guidance_v0/` |
