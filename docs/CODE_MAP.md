...
| TARO O0M 独立 analytic runtime | [`taro_o0m_runtime/README.md`](../scripts/research/taro_o0m_runtime/README.md) | `o0m_mechanics.py`、`run_o0m_canary.py`、`test_o0m_mechanics.py`；当前实现已锁、execution 未授权 |
