...
| Assistive Geometry 训练、三 seed 合成评估与数学 canary | [`assistive_geometry/README.md`](../scripts/research/assistive_geometry/README.md) | `train_b1_a0_formal.py`、`evaluate_b1_a0_synthetic.py`、`run_b1_a0_evaluation_dry_run.py`、`run_hypothesis_canary_lite.py` |
