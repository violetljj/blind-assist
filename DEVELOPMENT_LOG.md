...
## 2026-09-09
- violjjet: Preserve the previously untracked July RCLE synthetic scene/stress source, tests and dated documents on their original branch before storage cleanup. No algorithm, threshold, outcome or claim changes. AST/JSON checks passed; 41 focused tests yielded 25 pass, 13 errors and 3 failures from frozen NumPy identity and migrated parent-path constraints. See [preservation note](docs/research/rcle/RCLE_SYNTHETIC_SNAPSHOT_PRESERVATION_2026-09-09.md).
## 2026-07-27
