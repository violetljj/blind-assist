...
- 月度历史归档：[2026-05](docs/history/development-log/2026-05.md) · [2026-06](docs/history/development-log/2026-06.md)。根文件只保留最近 2–4 周；归档仅迁移原文，不改变当时结论。
