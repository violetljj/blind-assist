...
include(":goal-capture-app")
include(":semantic-anchor-demo-app")
include(":core:vision")
include(":core:device")
include(":core:ui")
...
project(":goal-capture-app").projectDir = file("apps/demos/goal-capture-app")
project(":semantic-anchor-demo-app").projectDir = file("apps/demos/semantic-anchor-demo-app")
