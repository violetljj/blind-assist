...
- `run_research_tool.py ba-adt-real-evidence <acquire_sample.py|mine_goal_episodes.py>`：下载有界 ADT sample RGB/GT 并运行 GT-only Goal Episode Miner；GT 只用于 mining/evaluation，不得进入后续 RGB estimator。
