...
- [`research/central_obstruction_agent_label_readiness_d0a/`](research/central_obstruction_agent_label_readiness_d0a/)：中央图像阻塞 D0-A0 reuse-first 输入宇宙，以及 D0-A1 排除式 calibration ROI/prompt/event/audit lock、write-once pilot input、非隔离 primary review 与独立 validator；D0-A2/模型效果仍关闭。
