...
LOCKED_FILES = (
    ...
    "apps/benchmarks/device-benchmark/build.gradle.kts",
    "apps/benchmarks/device-benchmark/src/main/java/com/linnan/blindassist/benchmark/ProductionTemporalGeometryFactorialAbDeviceTest.kt",
