...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    source_table = [["Dataset", "Access/status", "Receipt kind", "Candidates", "RGB media"]]
    ...
    lines = [
        ...
        "- Public extracted EgoWalk trajectories/RGB, public SANPO GCS metadata, and open THOR tracks/LiDAR were handled through source receipts; raw/gated sources were not bypassed.",
        "",
        ...
        "- Completed RGB A/B/C, geometry, counterexample, and final-adjudicator reviews are zero; agreement and re-review rates are undefined, not zero.",
        "",
    ...
    lines.extend([
        ...
        "## 10. Data gaps",
        "",
        "- No independent RGB A/B/C/geometry/counterexample/final-adjudication execution has been completed.",
        "- EgoWalk raw recordings, Project Aria terms/download, JRDB full access, THOR synchronized video, THOR-MAGNI materialization, Ego4D, and Ego-Exo4D remain blocked, partial, or not lawfully closed in the receipts.",
