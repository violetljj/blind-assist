#!/usr/bin/env python3
"""HEAD-only preflight for frozen D3R1 Phase-B depth/confidence assets."""
...
PROTOCOL_SCHEMA = "blindassist_depthart_task_preserving_d3r1_phase_b_head_protocol_v1"
SCOPE_SCHEMA = (
...
ACTIVATION_SCHEMA = "blindassist_depthart_task_preserving_d3r1_phase_b_head_activation_v1"
RESULT_SCHEMA = "blindassist_depthart_task_preserving_d3r1_phase_b_asset_header_preflight_v1"
PROTOCOL_ID = "DEPTHART_TASK_PRESERVING_D3R1_PHASE_B_DEPTH_CONFIDENCE_HEAD_ONLY_PREFLIGHT"
ASSETS = ("lowres_depth.zip", "confidence.zip")
PASS_TERMINAL = "D3R1_PHASE_B_ASSET_HEADERS_64_OF_64_AVAILABLE_MEDIA_BODY_UNOPENED"
UNAVAILABLE_TERMINAL = "D3R1_PHASE_B_ASSETS_NOT_AVAILABLE_MEDIA_BODY_UNOPENED"
INCOMPLETE_TERMINAL = "D3R1_PHASE_B_HEADER_PREFLIGHT_INCOMPLETE_MEDIA_BODY_UNOPENED"
PASS_SUCCESSOR = "EXPLICIT_D3R1_PHASE_B_DEPTH_CONFIDENCE_BODY_AND_SOURCE_TRUTH_SUPPORT_ACTIVATION"
...
def selection_rows(
    ...
    require(
        ...
        == "D3R1_EXACT_32_PHASE_B_DEPTH_CONFIDENCE_SOURCE_SCOPE_REGISTERED_MEDIA_UNOPENED",
        "source-scope status drift",
    )
    require(
        source_scope.get("next_gate")
        == "EXPLICIT_D3R1_PHASE_B_DEPTH_CONFIDENCE_HEAD_ONLY_PREFLIGHT_ACTIVATION",
    ...
    require(registered["future_head_request_count"] == 64, "registered HEAD count drift")
...
def validate_bindings(
    ...
    for entry, label in (
        ...
        (protocol["d3r1_recovery_protocol"], "D3R1 recovery protocol"),
    ...
    require(authority["phase_b_head"] is True, "Phase-B HEAD not authorized")
    require(
    ...
    return protocol, scope, phase_a_result
