...
from scripts.research.hftf.deployment.depthart import (
    census_depthart_task_preserving_d3r2_phase_b_source_coverage as producer,
)
from scripts.research.hftf.deployment.depthart import (
    validate_depthart_task_preserving_d3r2_phase_b_source_coverage as validator,
)
...
class SourceCoverageTests(unittest.TestCase):
    ...
    def test_activation_refuses_scientific_authority(self) -> None:
        activation = {
            ...
            "activated_by": "user",
            "status": "D3R2_PHASE_B_SOURCE_MEMBER_COVERAGE_CENSUS_ACTIVATED",
    ...
    def test_validator_rejects_terminal_http_retry_history(self) -> None:
        ...
        receipt = {
            ...
            "attempt_history": [
                {"attempt": 1, "method": "GET", "http_status": 404, "error": "HTTPError: 404", "error_type": "HTTPError", "retry_class": "TERMINAL"},
                {"attempt": 2, "method": "GET", "http_status": 200, "error": None, "error_type": None, "retry_class": None},
            ],
