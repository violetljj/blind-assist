...
from scripts.research.dual_loop_d0_egomotion_error_attribution_r2.validate_implementation_lock import (
    ACTIVATION_SCHEMA,
    LOCK_SCHEMA,
    PROTOCOL_ID,
    ...
    def test_valid_synthetic_lock_and_activation_identity(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            activation = {
                ...
                "formal_output_root": "artifacts.local/d0/run-r2",
                "repository": repository,
                "implementation_lock": {
                    "path": lock_path.relative_to(root).as_posix(),
                    "sha256": sha256_file(lock_path),
            ...
            identity = validate_activation_identity(
                ...
                lock_path,
                root,
                expected_formal_output_root="artifacts.local/d0/run-r2",
            )
